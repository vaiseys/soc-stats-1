...
We'll talk more about how to use these values soon. For now, just remember that a deviation from the mean of that size or less would not be unusual.
...
:::callout-tip
## Consider
In what ways is this approximation good? In which ways is it bad?
:::