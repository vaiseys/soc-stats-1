...
This language can feel weird. We can never accept the null hypothesis because the probability of an exact value (like .5) being true is basically zero. So we can either _reject_ the null hypothesis or _fail to reject it_.
